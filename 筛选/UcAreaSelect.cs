            ...
            if (areaInfos != null)
                foreach (var item in areaInfos)
                {
                    ...
                    if (ShowBlock)
                    {
                        ...
                        g.DrawString($"{item.Info}", this.Font, new SolidBrush(item.Color), rect, new StringFormat() { Alignment = StringAlignment.Center, LineAlignment = StringAlignment.Center });
                    }
                }
        }
    }
